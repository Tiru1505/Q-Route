...
ROOT = Path(__file__).resolve().parents[2]        # repository root: data/, results/
BACKEND = Path(__file__).resolve().parents[1]     # backend/: the code and its config
...
PLACES_FILE = BACKEND / "config/places.yaml"
